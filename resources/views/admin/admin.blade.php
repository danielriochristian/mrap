      ...
      <div class="row">
        ...
        <div class="col-lg-8 col-md-8 col-sm-12 col-xs-12">
          <ul class="navbar-nav navbar-right" style="margin-top:2%;">
            ...
            <li class="dropdown">
              <a href="#" class="dropdown-toggle" data-toggle="dropdown" role="button" aria-haspopup="true" aria-expanded="false">{{DB::table('users')->where('roles_id','=','2')->first()->name}} <span class="caret"></span></a>
         ...
         <div class="row">
             <div class="col-lg-12 col-md-12 col-sm-12 col-xs-12">
                 <ul class="nav nav-tabs notika-menu-wrap menu-it-icon-pro">
                     <li class="active"><a  href="#"><i class="notika-icon notika-mail"></i> Announcement</a>
                     </li>
                     <li><a href="#"><i class="notika-icon notika-edit"></i> Meeting</a>
                     </li>
                     <li><a href="#"><i class="notika-icon notika-bar-chart"></i> Resources</a>
                     </li>
                     <li><a href="#"><i class="notika-icon notika-bar-chart"></i> Calendar</a>
                     </li>
                     <li><a href="/memberarea/workinggroup"><i class="notika-icon notika-bar-chart"></i> Working Groups</a>
                     </li>
                 </ul>
             </div>
         </div>
